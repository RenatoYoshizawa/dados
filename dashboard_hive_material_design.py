...
[data-testid="stHeader"] { background: rgba(248,250,253,0.92); }
...
def render_mensagem_tabela(texto: str):
    st.markdown(
        ...
        <div style="
            ...
            font-size: 13px;
            font-weight: 700;
            box-shadow: 0 1px 2px rgba(60,64,67,.20), 0 1px 3px rgba(60,64,67,.12);
        ">{texto}</div>
        """,
        unsafe_allow_html=True,
    )
...
for titulo_servico, chave_servico in servicos_tabelas:
    st.markdown(
        f'<div style="font-size:13px; font-weight:900; color:#202124; margin:14px 0 8px 0;">{titulo_servico}</div>',
        unsafe_allow_html=True,
    )
